 ...
 * user：lqm
 * desc：水波浪进度框
 *      src:https://www.jianshu.com/p/34bbcd80dc7a
 */
...
public class WaveProgressView  extends View{
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        waveWidth = typedArray.getDimension(R.styleable.WaveProgressView_wave_width, DensityUtils.dp2px(context,25));
        waveHeight = typedArray.getDimension(R.styleable.WaveProgressView_wave_height,DensityUtils.dp2px(context,5));
        ...
        defaultSize = DensityUtils.dp2px(context,100);
